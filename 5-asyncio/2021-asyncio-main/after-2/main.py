...
#generic mechanism of running programs here
...
async def main() -> None:
    ...
    #async call to fn in parallel -> return tuple with result of fn calls
    ...
    # run the programs - part of progams sequential and parallel
    #everything awaitable so nest these functions
